...
if (DOXYGEN_FOUND)
  ...
  if (LATEX_COMPILER AND DVIPS_CONVERTER AND 
    ...
    if (EXISTS "${AMD_SOURCE_DIR}/doc/doxygen.config.in")
      configure_file (${AMD_SOURCE_DIR}/doc/doxygen.config.in
                      ${AMD_BINARY_DIR}/doc/doxygen.config
                      @ONLY)
      add_custom_target (doc 
                         ${DOXYGEN_EXECUTABLE}
                         ${AMD_BINARY_DIR}/doc/doxygen.config)
    else (EXISTS "${AMD_SOURCE_DIR}/doc/doxygen.config.in")
      message (STATUS "Configuration file not found. Cannot build docs")
    endif (EXISTS "${AMD_SOURCE_DIR}/doc/doxygen.config.in")
